...
// Mapa de nombres — 43 idiomas, sincronizado con FINAL_detectar_idioma.js
const mapaIdiomas = {
...
║  CLIENT SPEAKS: ${idiomaNombreEN.toUpperCase().padEnd(37)}║
║  YOU MUST RESPOND IN: ${idiomaNombreEN.toUpperCase().padEnd(31)}║
║  DEBES RESPONDER EN: ${idiomaDetectado.toUpperCase().padEnd(32)}║
